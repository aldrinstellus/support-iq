...
export const agentDashboardDemo: AgentDashboardData = {
  ...
  tickets: [
    {
      id: '#2901',
      subject: 'Production system down - urgent assistance needed',
      customer: 'Acme Corporation',
      priority: 'critical',
      status: 'in-progress',
      createdAt: '2026-01-26T08:15:00Z',
      dueAt: '2026-01-26T11:15:00Z',
      lastResponseAt: '2026-01-26T08:45:00Z',
      needsResponse: true,
      isDueSoon: true,
      slaStatus: 'warning',
    ...
    {
      id: '#2894',
      subject: 'Unable to access admin dashboard after update',
      customer: 'TechStart Inc.',
      priority: 'high',
      status: 'open',
      createdAt: '2026-01-25T14:30:00Z',
      dueAt: '2026-01-26T14:30:00Z',
      lastResponseAt: '2026-01-25T15:00:00Z',
      needsResponse: true,
      isDueSoon: true,
      slaStatus: 'warning',
    ...
    {
      id: '#2890',
      subject: 'API rate limiting causing integration failures',
      customer: 'DataFlow Systems',
      priority: 'high',
      status: 'pending',
      createdAt: '2026-01-25T10:00:00Z',
      dueAt: '2026-01-26T10:00:00Z',
      lastResponseAt: '2026-01-25T11:30:00Z',
      needsResponse: true,
      isDueSoon: true,
      slaStatus: 'warning',
      category: 'API Issue',
    ...
    {
      id: '#2887',
      subject: 'Need help configuring SSO with Okta',
      customer: 'Global Finance Ltd.',
      priority: 'medium',
      status: 'in-progress',
      createdAt: '2026-01-24T16:00:00Z',
      dueAt: '2026-01-27T16:00:00Z',
      lastResponseAt: '2026-01-26T09:00:00Z',
      needsResponse: false,
      isDueSoon: false,
      slaStatus: 'ok',
    ...
    {
      id: '#2874',
      subject: 'Report export timing out for large datasets',
      customer: 'Analytics Pro',
      priority: 'medium',
      status: 'open',
      createdAt: '2026-01-24T09:00:00Z',
      dueAt: '2026-01-28T09:00:00Z',
      lastResponseAt: '2026-01-24T10:00:00Z',
      needsResponse: true,
      isDueSoon: false,
      slaStatus: 'ok',
    ...
    {
      id: '#2865',
      subject: 'Question about billing cycle changes',
      customer: 'SmallBiz Solutions',
      priority: 'low',
      status: 'waiting',
      createdAt: '2026-01-23T11:00:00Z',
      dueAt: '2026-01-30T11:00:00Z',
      lastResponseAt: '2026-01-25T14:00:00Z',
      needsResponse: false,
      isDueSoon: false,
      slaStatus: 'ok',
      category: 'Billing',
...
// Risk Register Dashboard Widget Data
export const riskRegisterDemo: RiskRegisterData = {
  title: 'Program Risk Register',
  programName: 'Enterprise Digital Modernization',
  programId: 'PRG-2025-001',
  ...
  risks: [
    {
      ...
      description: 'Legacy mainframe systems may require additional middleware development to support modern API integration patterns.',
      category: 'technical',
      impact: 'critical',
      probability: 'likely',
      riskScore: 85,
      ...
      mitigation: {
        strategy: 'Implement phased integration approach with middleware abstraction layer',
        actions: [
          'Deploy API gateway for legacy system abstraction',
      ...
      contingency: 'Parallel legacy system support for 6 months post-migration',
      affectedAreas: ['Data Migration', 'User Authentication', 'Reporting'],
      lastReviewDate: '2026-01-20',
    },
    {
      id: 'RISK-002',
      title: 'Resource Availability During Peak Periods',
      description: 'Key technical resources may be unavailable during critical implementation phases due to competing project demands.',
      category: 'resource',
      impact: 'high',
      ...
      mitigation: {
        strategy: 'Cross-training program and resource reservation agreements',
        actions: [
          'Identify backup resources for critical roles',
          'Implement knowledge transfer sessions',
          'Secure contractor support agreement',
        ],
        progress: 60,
      },
      affectedAreas: ['Development', 'Testing', 'Deployment'],
      lastReviewDate: '2026-01-18',
    },
    {
      id: 'RISK-003',
      title: 'Budget Overrun Due to Scope Changes',
      description: 'Stakeholder-requested scope changes may exceed allocated budget reserves.',
      category: 'budget',
      impact: 'high',
      probability: 'likely',
      riskScore: 78,
      ...
      mitigation: {
        strategy: 'Implement strict change control process with cost impact analysis',
        actions: [
          'Establish change control board',
          'Create scope change impact template',
          'Define budget threshold triggers',
        ],
        progress: 30,
      },
      affectedAreas: ['All Phases', 'Contract Management'],
      lastReviewDate: '2026-01-22',
    },
    {
      id: 'RISK-004',
      title: 'Vendor Delivery Delays',
      description: 'Third-party software vendor may miss committed delivery dates for critical components.',
      category: 'external',
      impact: 'critical',
      probability: 'possible',
      riskScore: 80,
      ...
      mitigation: {
        strategy: 'Establish regular vendor checkpoints and alternative vendor evaluation',
        actions: [
      ...
      contingency: 'Switch to alternative vendor with 4-week implementation timeline',
      affectedAreas: ['Infrastructure', 'Security Compliance'],
      lastReviewDate: '2026-01-25',
    },
    {
      id: 'RISK-005',
      title: 'Data Quality Issues During Migration',
      description: 'Historical data may have inconsistencies that require extensive cleansing before migration.',
      category: 'technical',
      impact: 'high',
      ...
      mitigation: {
        strategy: 'Implement automated data validation and cleansing pipeline',
        actions: [
          'Deploy data profiling tools',
          'Create validation rules engine',
          'Establish data stewardship team',
        ],
        progress: 70,
      },
      affectedAreas: ['Data Migration', 'Reporting', 'Analytics'],
      lastReviewDate: '2026-01-24',
    },
    {
      id: 'RISK-006',
      title: 'Security Compliance Certification Delay',
      description: 'FedRAMP certification process may take longer than anticipated.',
      category: 'compliance',
      impact: 'medium',
      probability: 'possible',
      riskScore: 55,
      ...
      mitigation: {
        strategy: 'Engage compliance consultant and parallel documentation effort',
        actions: [
          'Hire FedRAMP specialist',
          'Pre-audit readiness assessment',
          'Documentation automation',
        ],
        progress: 40,
      },
      affectedAreas: ['Deployment', 'Go-Live'],
      lastReviewDate: '2026-01-15',
    },
    {
      id: 'RISK-007',
      title: 'User Adoption Resistance',
      description: 'End users may resist new system adoption due to change fatigue from recent process changes.',
      category: 'resource',
      impact: 'medium',
      probability: 'likely',
      riskScore: 60,
      ...
      mitigation: {
        strategy: 'Comprehensive change management and early user engagement program',
        actions: [
      ...
      affectedAreas: ['Training', 'Rollout', 'Support'],
      lastReviewDate: '2026-01-20',
    },
    {
      id: 'RISK-008',
      title: 'Schedule Slip Due to Testing Delays',
      description: 'UAT may require additional cycles due to integration testing findings.',
      category: 'schedule',
      impact: 'medium',
      probability: 'possible',
      riskScore: 48,
      ...
      mitigation: {
        strategy: 'Shift-left testing approach with continuous integration',
        actions: [
      ...
      affectedAreas: ['Testing', 'Deployment Timeline'],
      lastReviewDate: '2026-01-23',
    },
  ],
  riskMatrix: {
    criticalHigh: 2,
  ...
  recentChanges: [
    {
      riskId: 'RISK-003',
      riskTitle: 'Budget Overrun Due to Scope Changes',
      changeType: 'new',
      newState: 'Open',
      changedBy: 'Alexa Johnson',
      changedDate: '2026-01-22',
    },
    {
      riskId: 'RISK-001',
      riskTitle: 'Integration Complexity with Legacy Systems',
      changeType: 'updated',
      previousState: '35% mitigated',
      newState: '45% mitigated',
      changedBy: 'Dale Thompson',
      changedDate: '2026-01-20',
    },
    {
      riskId: 'RISK-005',
      riskTitle: 'Data Quality Issues During Migration',
      changeType: 'de-escalated',
    ...
    {
      riskId: 'RISK-008',
      riskTitle: 'Schedule Slip Due to Testing Delays',
      changeType: 'new',
      newState: 'Open',
      changedBy: 'Molly Rivera',
      changedDate: '2026-01-18',
    },
  ],
  upcomingReviews: [
    {
      ...
      reviewer: 'Dale Thompson',
    },
    {
      riskId: 'RISK-004',
      riskTitle: 'Vendor Delivery Delays',
      reviewDate: '2026-01-30',
      reviewer: 'Herbert Roberts',
    },
    {
      riskId: 'RISK-003',
      riskTitle: 'Budget Overrun Due to Scope Changes',
...
// Code Review Dashboard Widget Data
export const codeReviewDemo: CodeReviewDashboardData = {
  title: 'Code Review Dashboard',
  lastUpdated: 'January 26, 2026 • 10:30 AM',
  summary: {
    totalPending: 12,
    needsYourReview: 5,
    awaitingYourChanges: 2,
    approved: 8,
    merged: 24,
    averageReviewTime: '4.2 hours',
    reviewVelocity: 'normal',
  },
  pendingReviews: [
    {
      id: 'PR-847',
      title: 'feat: Add real-time notification system',
      author: 'Emily Rodriguez',
      repository: 'support-portal',
      ...
      reviewers: [
        { name: 'Herbert Roberts', status: 'pending' },
        { name: 'Dale Thompson', status: 'approved' },
      ],
    ...
    },
    {
      ...
      priority: 'critical',
      labels: ['bug', 'hotfix', 'performance'],
      reviewers: [
        { name: 'Herbert Roberts', status: 'changes-requested' },
        { name: 'Jennifer Chen', status: 'pending' },
      ],
      checksStatus: 'passing',
    },
    {
      id: 'PR-843',
      title: 'refactor: Modernize authentication flow',
      ...
      reviewers: [
        { name: 'Herbert Roberts', status: 'approved' },
        { name: 'Emily Rodriguez', status: 'approved' },
      ],
      checksStatus: 'passing',
    },
    {
    ...
    {
      id: 'PR-839',
      title: 'test: Add integration tests for ticket workflow',
      author: 'Molly Rivera',
      repository: 'support-api',
      branch: 'test/ticket-integration',
      targetBranch: 'develop',
      createdAt: '2026-01-21T09:00:00Z',
      updatedAt: '2026-01-26T07:45:00Z',
      linesAdded: 456,
      linesRemoved: 12,
      filesChanged: 8,
      comments: 6,
      ...
      status: 'needs-rebase',
      priority: 'normal',
      labels: ['testing', 'needs-rebase'],
      reviewers: [
        { name: 'Herbert Roberts', status: 'commented' },
        { name: 'Dale Thompson', status: 'pending' },
      ],
  ...
  yourPullRequests: [
    {
      id: 'PR-846',
      title: 'feat: Implement team workload balancing',
      repository: 'support-portal',
      status: 'open',
      createdAt: '2026-01-25T08:00:00Z',
      reviewStatus: 'changes-requested',
      reviewers: ['Dale Thompson', 'Emily Rodriguez'],
      comments: 7,
    },
    {
      id: 'PR-840',
      title: 'fix: Correct SLA calculation for enterprise tier',
      repository: 'support-api',
      status: 'open',
      createdAt: '2026-01-22T13:30:00Z',
      reviewStatus: 'awaiting-review',
      reviewers: ['Jennifer Chen'],
      comments: 0,
    },
  ],
  recentActivity: [
    {
      type: 'comment',
      pullRequestId: 'PR-847',
      pullRequestTitle: 'feat: Add real-time notification system',
      user: 'Dale Thompson',
      timestamp: '2026-01-26T09:15:00Z',
      content: 'LGTM! Just one minor suggestion on the event handler naming.',
    },
    {
      type: 'approval',
      pullRequestId: 'PR-843',
      pullRequestTitle: 'refactor: Modernize authentication flow',
      user: 'Emily Rodriguez',
      timestamp: '2026-01-25T17:30:00Z',
    },
    {
      type: 'request-changes',
      pullRequestId: 'PR-845',
      pullRequestTitle: 'fix: Resolve memory leak in WebSocket handler',
      user: 'Herbert Roberts',
      timestamp: '2026-01-25T16:00:00Z',
      content: 'The cleanup function needs to be called on disconnect as well.',
    },
    {
      type: 'push',
      pullRequestId: 'PR-846',
      pullRequestTitle: 'feat: Implement team workload balancing',
      user: 'Herbert Roberts',
      timestamp: '2026-01-25T14:00:00Z',
    },
    {
      type: 'merge',
      pullRequestId: 'PR-838',
      pullRequestTitle: 'chore: Update dependencies to latest versions',
      user: 'Dale Thompson',
      timestamp: '2026-01-24T18:30:00Z',
    },
  ],
  metrics: {
    reviewsCompletedThisWeek: 18,
...
export function getWidgetDemoData(widgetType: string): WidgetData | null {
  const dataMap: Record<string, WidgetData> = {
    ...
    // Risk Register Dashboard
    'risk-register-dashboard': riskRegisterDemo,
    // Code Review Dashboard
    'code-review-dashboard': codeReviewDemo,
  };
