...
// NPS & Sentiment Analysis Widget Data
export interface NPSSentimentData {
  title?: string;
  // Internal data is generated by the widget component
  // This is a minimal interface for type compatibility
}
